    ...
    return(
        <nav className="flex dark:bg-white items-center relative justify-between bg-white px-8 py-3 w-full border border-gray-300">
            <div className="flex items-center space-x-2">
                ...
                <p className="font-semibold text-xl">Neutron <span className="text-violet-500 text-xl font-semibold">Imager</span></p>
            </div>
            <form className="flex-grow px-20">
                <div className="relative">
                    ...
                    <input type="search" id="default-search" className="block border border-gray-300 dark:focus:border-blue-500 dark:focus:ring-blue-500 dark:placeholder-gray-400 focus:border-blue-500 focus:ring-blue-500 p-4 pl-10 pr-20 rounded-xl text-gray-900 text-sm w-full" placeholder="Type to search"/>
                </div>
            </form>
