            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table className="w-full text-sm text-left">
                    ...
                    <tr className="bg-white border-b dark:bg-white dark:border-gray-300 hover:bg-gray-200">
                        ...
                        <td className="px-6 py-4">
                            <p className="font-normal text-gray-400">dr. Slamet Sukma Djaja, Sp.PD</p>
                        </td>
                    ...
                    <tr className="bg-white border-b dark:bg-white dark:border-gray-300 hover:bg-gray-200">
                        ...
                        <td className="px-6 py-4 text-right text-gray-500">
                            <div className="flex gap-x-2">
                                <button className="px-4 py-1 bg-red-500 rounded-full text-white font-semibold">Reject</button>
                                <button className="px-4 py-1 bg-violet-500 rounded-full text-white font-semibold">Detail</button>
                            </div>
                        </td>
                    </tr>
                    <tr className="bg-white border-b dark:bg-white dark:border-gray-300 hover:bg-gray-200">
